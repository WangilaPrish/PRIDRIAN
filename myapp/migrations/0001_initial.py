# Generated by Django 4.2 on 2025-02-08 14:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image1', models.ImageField(blank=True, null=True, upload_to='products/', validators=[myapp.models.validate_image_extension])),
                ('image2', models.ImageField(blank=True, null=True, upload_to='products/', validators=[myapp.models.validate_image_extension])),
                ('image3', models.ImageField(blank=True, null=True, upload_to='products/', validators=[myapp.models.validate_image_extension])),
                ('image4', models.ImageField(blank=True, null=True, upload_to='products/', validators=[myapp.models.validate_image_extension])),
            ],
        ),
        migrations.CreateModel(
            name='Wishlist',
